...
@section('content')
    ...
    <section class="text-gray-600 bg-green-50 body-font">
        <div class="px-5 py-8 mx-auto flex flex-wrap items-center -m-4">
            @if ($products->isEmpty())
                <div class="flex flex-col justify-center ">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/product-is-empty-8044872-6430781.png"
                        alt="">
                    ...
                    <div class=" lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            @if ($product->quantity == 0)
                                <button
                                    class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">out
                                    of stock</button>
                            @else
